...
export const metadata = {
  ...
  title: {
    default: 'MashSub  AI - AI-Powered Interview Preparation',
    template: '%s | MashSub AI'
  },
  ...
  authors: [{ name: 'MashSub AI Team' }],
  creator: 'MashSub AI',
  publisher: 'MashSub AI',
  
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://mockmateai-eta.vercel.app/',
    title: 'MashSub AI - AI-Powered Interview Preparation',
    description: 'Elevate your interview skills with AI-powered mock interviews. Get personalized coaching, real-time feedback, and boost your confidence.',
    siteName: 'MashSub AI',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'MashSub AI - Revolutionizing Interview Preparation'
      }
    ]
  },
